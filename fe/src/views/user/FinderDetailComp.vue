        ...
        <div class="grid-container">
            <v-data-table-server
                ...
                <template v-slot:item="{ item }">
                    <tr class="grid-tr">
                        <td class="grid-td" :title="item.orgNm">{{ item.orgNm }}</td>
    ...
    export default {
        ...
        data() {
            return {
                ...
                password: "",
                headers: [
                    { width:"100",title: '기업구분', align: 'center', key: 'orgNm' },
                    { width:"150",title: '업체명', align: 'center', key: 'appNm' },
                    ...
                    { width:"80",title: '존속일자', align: 'center', key: 'conDate' },
